...
REQUIREMENTS
------------
End users: Windows 10/11 (64-bit), Python 3.12 or 3.13 from python.org.
...
1. On first run, click **Install / Update** in the sidebar and then **Install TwinVine Tools**.
   You can check the log TAB for a more detailed view of the installation.
2. Once installed, return to the **Home** and search for you desired title or paste the URL directly then click a service button (BBC, ITVX, etc.).
3. You can also just click on a service and choose how to search — by keyword, URL, or browse by category.
...
- **HLG** — Enables HDR/HLG streams when ticked (default on). Restart the app and untick HGL if you see a
  "Selection unavailable in UHD" error when trying to download something.
...
Multiple episodes download sequentially — you can mix episodes from different series numbers.
...
- If you delete your envied.yaml you will need to re-enter your credentials and settings, so it advisable to save a copy of this file in a different location first.

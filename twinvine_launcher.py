...
APP_VERSION     = "1.0.3"
# SHA of the commit this launcher .py file was built/exported from.
# Set this to the actual commit SHA (short, 12 chars) when pushing a new
# version to GitHub's main branch. Used to detect whether a newer
# launcher is available, independent of when/where it was installed.
LAUNCHER_COMMIT = "e0ffbeadffaf"
...
class TwinVineLauncher(QMainWindow):
    ...
    def _check_updates(self):
        ...
        self._update_thread = _UpdateCheckThread(LAUNCHER_COMMIT)

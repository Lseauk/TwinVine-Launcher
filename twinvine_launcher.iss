...
;
; Build steps:
;   Open this .iss file in Inno Setup and click Compile
;   Output: installer_output\TwinVine Launcher-Setup-1.0.4.exe

#define MyAppName "TwinVine Launcher"
#define MyAppVersion "1.0.4"
#define MyAppVersionFile "1.0.4"
...
OutputBaseFilename=TwinVine Launcher-Setup-1.0.4
